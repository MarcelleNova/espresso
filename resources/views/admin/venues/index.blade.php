						...
						<table id="indextable" class="table table-bordered table-hover table-sm text-sm">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $v->name }}</td>
									<td> {{ $v->description}}</td>
									<td><a href="{{ route('admin.venues.edit',$v->id) }}" class="btn btn-info btn-xs">Edit</a> 
										{{-- <a href="javascript:void(0)" onclick="$(this).parent().find('form').submit()" class="btn btn-danger btn-xs">Delete</a> --}}
										{{-- <form action="{{route('admin.venues.destroy',$v->id) }}" method="post">
											@method('DELETE')
								...
								@endforeach
								@else
								<tr><td colspan="5">No Venues</td></tr>
								@endif
							</tbody>
						</table>
						...
						<div class="modal-dialog modal-dialog-centered modal-lg">
							<div class="modal-content">
								<div class="modal-header">
									<h3 class="modal-title">Add Venue</h3>
									...
									<form method="post" action="{{ route('admin.venues.store') }}">
											...
											<div class="form-group">
												<div class="row">
													...
													<div class="col-md-6"><input type="text" name="code" class="form-control">
													</div>
												</div>
												<div class="row">
