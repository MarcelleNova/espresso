			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Call Data Manual Daily Import - Full Day</h3>
					...
					<div class="card-body">
						...
						<div class="alert alert-info alert-block" id="session-alert">
						...
						@endif
							...
							<form id="fulldayform" method="post" action="{{ route('calls.import.calls') }}" class="fileform" enctype="multipart/form-data">
								@csrf
								<div class="form-group">
									<div class="row mt-3">
										<label class="col-md-3">
											Select File for Full Day Call Import
									...
									<div class="row mb-5">
										...
										<div class="col-md-7">
											Path to call Data is \\platdc\SFTP_Root\SCP Folder\Nova Life\Full Day
										</div>
									</div>
							</form>
				
							<form method="post" action="{{ route('calls.import.calls') }}" class="fileform" enctype="multipart/form-data">
								@csrf
								<div class="form-group">
									<div class="row mb-2">
